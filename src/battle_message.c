...
static const u8 sText_PkmnGainedEXP[] = _("{B_BUFF1} kreeg{B_BUFF2}\n{B_BUFF3} IeksPee!\p");
static const u8 sText_PkmnGainedEXPAll[] = _("De rest vant team kreeg Ieks\nPee dankzij IekPeeShare.\p");
static const u8 sText_EmptyString4[] = _("");
static const u8 sText_ABoosted[] = _(" a boosted");
static const u8 sText_PkmnGrewToLv[] = _("{B_BUFF1} is nu\nLv. {B_BUFF2}!{WAIT_SE}\p");
static const u8 sText_PkmnLearnedMove[] = _("{B_BUFF1} ljirde\n{B_BUFF2}!{WAIT_SE}\p");
static const u8 sText_TryToLearnMove1[] = _("{B_BUFF1} probjirt\n{B_BUFF2} te ljirn.\p");
static const u8 sText_TryToLearnMove2[] = _("Ma, {B_BUFF1} kan ma max.\n4 aanvaln kenn'n.\p");
static const u8 sText_TryToLearnMove3[] = _("Wildje jin wegdoen\nen ploatse moak vo {B_BUFF2}?");
static const u8 sText_PkmnForgotMove[] = _("{B_BUFF1} verhat\n{B_BUFF2}.\p");
static const u8 sText_StopLearningMove[] = _("{PAUSE 32}Stoppen me\n{B_BUFF2} te ljirn?");
static const u8 sText_DidNotLearnMove[] = _("{B_BUFF1} é juste nietn\n geljird, zeker nie {B_BUFF2}.\p");
static const u8 sText_UseNextPkmn[] = _("Ne nieuwe 'mon smitn?");
static const u8 sText_AttackMissed[] = _("Niemand wit waar da {B_ATK_NAME_WITH_PREFIX}\noant mikn was!");
static const u8 sText_PkmnProtectedItself[] = _("{B_DEF_NAME_WITH_PREFIX}\nbeskermde zichzelve!");
static const u8 sText_AvoidedDamage[] = _("{B_DEF_NAME_WITH_PREFIX} vermeed\nskade me {B_DEF_ABILITY}!");
static const u8 sText_PkmnMakesGroundMiss[] = _("{B_DEF_NAME_WITH_PREFIX} doe Hrond\naanvaln teniet me {B_DEF_ABILITY}!");
static const u8 sText_PkmnAvoidedAttack[] = _("{B_DEF_NAME_WITH_PREFIX} ontweek\nden aanval!");
static const u8 sText_ItDoesntAffect[] = _("Da stikt gin klotn ut tegen\n{B_DEF_NAME_WITH_PREFIX}…");
...
static const u8 sText_WildFled[] = _("{PLAY_SE SE_FLEE}{B_LINK_OPPONENT1_NAME} is ontsnapt!");
static const u8 sText_TwoWildFled[] = _("{PLAY_SE SE_FLEE}{B_LINK_OPPONENT1_NAME} and\n{B_LINK_OPPONENT2_NAME} fled!");
static const u8 sText_NoRunningFromTrainers[] = _("Weglwopn van n'en Temmer?\nDadis vo jeannetn!\p");
static const u8 sText_CantEscape[] = _("Er is gin ontsnapn an!\p");
static const u8 sText_DontLeaveBirch[] = _("Prof. C.: IK ZWEEREM, WOAG ET NIE!\p");
...
const u8 gText_PkmnIsEvolving[] = _("Moh!\n{STR_VAR_1} evolueert!");
const u8 gText_CongratsPkmnEvolved[] = _("Allez proficiat zeg! Jen {STR_VAR_1}\n is nu n'en {STR_VAR_2}!{WAIT_SE}\p");
const u8 gText_PkmnStoppedEvolving[] = _("Wuk? {STR_VAR_1}\nis gestopt me evolueren!\p");
const u8 gText_EllipsisQuestionMark[] = _("……?\p");
const u8 gText_WhatWillPkmnDo[] = _("Wuk ga\n{B_ACTIVE_NAME_WITH_PREFIX} doen?");
const u8 gText_WhatWillPkmnDo2[] = _("Wuk ga\n{B_PLAYER_NAME} doen?");
const u8 gText_WhatWillWallyDo[] = _("Wuk ga de\nWally doen?");
...
static const u8 sText_HP[] = _("HaPé");
static const u8 sText_Attack[] = _("Attak");
static const u8 sText_Defense[] = _("Verdedig");
static const u8 sText_SpAtk[] = _("Sp. Atk");
static const u8 sText_SpDef[] = _("Sp. Vrd");
