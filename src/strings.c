...
const u8 gText_ExpandedPlaceholder_Sapphire[] = _("Saffier");
const u8 gText_ExpandedPlaceholder_Ruby[] = _("Robijn");
const u8 gText_ExpandedPlaceholder_Emerald[] = _("Smaragd");
const u8 gText_ExpandedPlaceholder_Aqua[] = _("Woatr");
const u8 gText_ExpandedPlaceholder_Magma[] = _("Mahma");
...
const u8 gText_EggNickname[] = _("Eier");
const u8 gText_Pokemon[] = _("Pokémon");
const u8 gText_ProfBirchMatchCallName[] = _("Prof. C.");
const u8 gText_MainMenuNewGame[] = _("VAN NUL BEHINNEN");
const u8 gText_MainMenuContinue[] = _("VEURTGOAN");
const u8 gText_MainMenuOption[] = _("OPTIE");
const u8 gText_MainMenuMysteryGift[] = _("Mysterisch Heschenk");
const u8 gText_MainMenuMysteryGift2[] = _("Mysterisch Heschenk");
const u8 gText_MainMenuMysteryEvents[] = _("Mysterische Hebeurtenis");
const u8 gText_WirelessNotConnected[] = _("Den droadlozen adapter\nnis nie verbond'n.");
const u8 gText_MysteryGiftCantUse[] = _("Mysterisch heschenk kun nie gebrukt wôrdn\nbinnest da den draodlozen adapter inzit.");
const u8 gText_MysteryEventsCantUse[] = _("Mysterische hebeurtenissen kun nie gebrukt wôrdn\nbinnest da den draodlozen adapter inzit.");
const u8 gText_UpdatingSaveExternalData[] = _("Jen ipslagbestand updaten me externe\nhehevens. Wacht e bikke."); // Unused
const u8 gText_SaveFileUpdated[] = _("The save file has been updated."); // Unused
const u8 gText_SaveFileCorrupted[] = _("Jen ipslagbestand is 't eran. Jen\nvorig ipslagbestand wird geloadn.");
const u8 gText_SaveFileErased[] = _("Jen ipslagbestand is 't eran.\n't Is hjil corrupt.");
const u8 gJPText_No1MSubCircuit[] = _("1Mサブきばんが ささっていません！");
const u8 gText_BatteryRunDry[] = _("De batterie is 't eran.\nGe kun nog spelen.\pMa tidgerelateerde evenementen\nwerken nie mee.\pGebrukt FAKE RTC\nast er gjin batterie is.");
...
const u8 gText_BirchBoy[] = _("VINT");
const u8 gText_BirchGirl[] = _("MEISKE");
...
const u8 gText_ThisIsAPokemon[] = _("Kieknekedaarsie, daar is 't em sè!{PAUSE 96}\p");
...
const u8 gText_CryOf[] = _("De kreet van den");
const u8 gText_EmptyPokedexInfo2[] = _(""); // Unused
const u8 gText_SizeComparedTo[] = _("Grwôte verheleken met ");
const u8 gText_PokedexRegistration[] = _("Pokédex rehistratie was e grwôt succes.");
const u8 gText_HTHeight[] = _("HT");
const u8 gText_WTWeight[] = _("WT");
const u8 gText_SearchingPleaseWait[] = _("Ben aan 't ZOEKEN…\nHEDULD AUB.");
const u8 gText_SearchCompleted[] = _("'k Et get me zoeken.");
const u8 gText_NoMatchingPkmnWereFound[] = _("Gin enkele match. Pech.");
const u8 gText_SearchForPkmnBasedOnParameters[] = _("Zoekt Pokémon hebaseerd ip\nbepoalde criteria.");
const u8 gText_SwitchPokedexListings[] = _("Gif mie een andere lijst.");
const u8 gText_ReturnToPokedex[] = _("Kerekewere.");
const u8 gText_SelectPokedexMode[] = _("Welke modus wildje.");
const u8 gText_SelectPokedexListingMode[] = _("Oe wildje ze oplijsten.");
const u8 gText_ListByFirstLetter[] = _("De jiste letter van de noame.\nEnkel dedie dak gezien e.");
const u8 gText_ListByBodyColor[] = _("Lichaamskleur.\nEnkel dedie dak gezien e.");
const u8 gText_ListByType[] = _("Type.\nEnkel dedie dak eb.");
const u8 gText_ExecuteSearchSwitch[] = _("Hoehel zoeken/switch.");
...
const u8 gText_DexSortHeaviestTitle[] = _("Vetzak Mode");
const u8 gText_DexSortLightestTitle[] = _("Dunzak Mode");
const u8 gText_DexSortTallestTitle[] = _("Lange slungel Mode");
const u8 gText_DexSortSmallestTitle[] = _("Pernukkel Mode");
...
const u8 gText_DexSearchColorRed[] = _("Rwo");
const u8 gText_DexSearchColorBlue[] = _("Blauw");
const u8 gText_DexSearchColorYellow[] = _("Heel");
const u8 gText_DexSearchColorGreen[] = _("Hroen");
const u8 gText_DexSearchColorBlack[] = _("Zwart");
const u8 gText_DexSearchColorBrown[] = _("Brun");
const u8 gText_DexSearchColorPurple[] = _("Poars");
const u8 gText_DexSearchColorGray[] = _("Hrijs");
const u8 gText_DexSearchColorWhite[] = _("Wit");
const u8 gText_DexSearchColorPink[] = _("Roze");
const u8 gText_DexHoennDescription[] = _("Oen regio's Pokédex");
const u8 gText_DexNatDescription[] = _("Nationale editie Pokédex");
const u8 gText_DexSortNumericalDescription[] = _("Pokémon zin opgelist volgens under\nnummer.");
const u8 gText_DexSortAtoZDescription[] = _("Dedie daje zelf et en gezien et\nen ton noh ke alfabetisch.");
const u8 gText_DexSortHeaviestDescription[] = _("Jen eigen Pokémon van vetzak\nna dunzak.");
const u8 gText_DexSortLightestDescription[] = _("Jen eigen Pokémon van dunzak\nna vetzak.");
const u8 gText_DexSortTallestDescription[] = _("Jen eigen Pokémon van de grwôtste\ntot de kleinste.");
const u8 gText_DexSortSmallestDescription[] = _("Jen eigen Pokémon van de\nkleinste tot de grwôtste.");
const u8 gText_DexEmptyString[] = _("");
const u8 gText_DexSearchDontSpecify[] = _("Nie specifiërn.");
const u8 gText_DexSearchTypeNone[] = _("Gin");
const u8 gText_SelectorArrow[] = _("▶");
const u8 gText_EmptySpace[] = _(" "); // Unused
const u8 gText_WelcomeToHOF[] = _("Ge zijt vree welgekomen in 't Stadhus!");
const u8 gText_HOFDexRating[] = _("Hezien: {STR_VAR_1}!\nGevangn: {STR_VAR_2}!\pProf. C.'s Pokédex score!\pProf. C.: Ke zien eh…\p");
const u8 gText_HOFDexSaving[] = _("Ipsloan…\nMoakt daje 't spel nie utzet of anders...");
const u8 gText_HOFCorrupted[] = _("De data van 't Stadhus is corrupt. Mindjem?");
const u8 gText_HOFNumber[] = _("Stadhus nr. {STR_VAR_1}");
const u8 gText_LeagueChamp[] = _("Liga Kampioen!\nProficiat whe!");
...
const u8 gText_BirchInTrouble[] = _("Prof. C. zit me de poepers!\nVerlos em uit zin lijden!");
const u8 gText_ConfirmStarterChoice[] = _("Zijet zeker? Gin tweede kans eh?");
const u8 gText_Pokemon4[] = _("Pokémon"); // Unused
const u8 gText_FlyToWhere[] = _("Woar wildje nu ne ke vliegn?");
const u8 gMenuText_Use[] = _("Gebrukn");
const u8 gMenuText_Toss[] = _("Smit ermee");
const u8 gMenuText_Register[] = _("Registeer");
const u8 gMenuText_Give[] = _("Geevn");
const u8 gMenuText_CheckTag[] = _("Checkt den Tag");
const u8 gMenuText_Confirm[] = _("Joat");
const u8 gMenuText_Walk[] = _("Wandeln");
const u8 gText_Cancel[] = _("Annuleer");
const u8 gText_Cancel2[] = _("Nint");
const u8 gMenuText_Show[] = _("Show ke");
const u8 gText_EmptyString2[] = _("");
const u8 gText_Cancel7[] = _("Cancel"); // Unused
const u8 gText_Item[] = _("Dink");
const u8 gText_Mail[] = _("Mail");
const u8 gText_Take[] = _("Pak");
const u8 gText_Store[] = _("Stockeer");
const u8 gMenuText_Check[] = _("Checkt");
const u8 gText_None[] = _("Gin");
const u8 gMenuText_Deselect[] = _("Deselecteer");
...
const u8 gText_GoBackPrevMenu[] = _("Kerekewere");
const u8 gText_WhatWouldYouLike[] = _("Wuk wildje nu doen?");
const u8 gMenuText_Give2[] = _("Geevn");
const u8 gText_xVar1[] = _("×{STR_VAR_1}");
const u8 gText_Berry2[] = _(" Berry"); // Unused
const u8 gText_Coins[] = _("{STR_VAR_1} Coins");
const u8 gText_CloseBag[] = _("Slut uwe Zak");
const u8 gText_Var1IsSelected[] = _("{STR_VAR_1} is\ngeselecteerd.");
const u8 gText_CantWriteMail[] = _("Ge kunt ier gin\nMail skrivn.");
const u8 gText_NoPokemon[] = _("Der nis hin\nPokémon.");
const u8 gText_MoveVar1Where[] = _("Woar wildje\n{STR_VAR_1}\ngoan zetn?");
const u8 gText_Var1CantBeHeld[] = _("Den {STR_VAR_1} kun nie vastg'oudn wôrdn.");
const u8 gText_Var1CantBeHeldHere[] = _("Den {STR_VAR_1} kun ier nie\nvastg'oudn wôrdn.");
const u8 gText_DepositHowManyVar1[] = _("Oevele\n{STR_VAR_1}(s) wildje afzettn?");
const u8 gText_DepositedVar2Var1s[] = _("Zovjille: {STR_VAR_2}\n{STR_VAR_1}(s) afgezet.");
const u8 gText_NoRoomForItems[] = _("Der is gin ploatse\nvo jen items.");
const u8 gText_CantStoreImportantItems[] = _("Peisdje gij nu\necht daje da in\nde pc kun steken, dwoazn!");
const u8 gText_TooImportantToToss[] = _("Smit da ke\nnie weg,\ngie roaren!");
const u8 gText_TossHowManyVar1s[] = _("Oevele wildje der wegsmitn: \n{STR_VAR_1}(s)?");
const u8 gText_ThrewAwayVar2Var1s[] = _("Weggesmitn: {STR_VAR_2}\n{STR_VAR_1}(s).");
...
const u8 gText_Yes[] = _("Joa");
const u8 gText_No[] = _("Nin");
...
const u8 gText_MenuOptionBag[] = _("Zak");
...
const u8 gText_DoubleKO[] = _("Dubbel KO");
...
const u8 gText_Exit[] = _("Kerekewere");
const u8 gText_ExitFromBox[] = _("De doze verloatn?");
...
const u8 gPCText_Cancel[] = _("Annuler'n");
...
const u8 gText_SaveCompleted[] = _("'t Is ipgesloan.");
...
const u8 gText_Easy[] = _("Batje");
const u8 gText_Hard[] = _("Lastig");
const u8 gText_Modern[] = _("Modern");
const u8 gText_Classic[] = _("Klassiek");
...
const u8 gText_Trade[] = _("Ruilen");
const u8 gText_Battle[] = _("Battrn");
...
const u8 gText_YesNo[] = _("Joa\nNin");//HIER IS DAT KEUZEMENU VOOR "YES" / "NO"
...
const u8 gText_Yes2[] = _("Joa");
const u8 gText_No2[] = _("Nin");
...
const u8 gText_Yes3[] = _("Joa");
const u8 gText_No3[] = _("Nin");
...
const u8 gText_Exit4[] = _("Kerekewere");
...
const u8 gText_IsThisTheCorrectTime[] = _("Is 't uure just?");
const u8 gText_Confirm3[] = _("Joat");
const u8 gText_Cancel4[] = _("Kerekewere");
...
const u8 gText_ChampionMatchCallDesc[] = _("Kampioen");
...
const u8 gText_Cancel5[] = _("Kerekewere");
const u8 gText_Ok2[] = _("OK");
const u8 gText_Quiz[] = _("Quiz");
const u8 gText_Answer[] = _("Answer");
const u8 gText_PokeBalls[] = _("Poké Balls");
const u8 gText_Berry[] = _("Bes");
const u8 gText_Berries[] = _("Bessen");
...
const u8 gText_Stats_CatchRate_Legend[]         = _("Legendarisch");
const u8 gText_Stats_CatchRate_VeryHard[]       = _("Vree moeilik");
const u8 gText_Stats_CatchRate_Difficult[]      = _("Moeilik");
const u8 gText_Stats_CatchRate_Medium[]         = _("Ca va nog");
const u8 gText_Stats_CatchRate_Relaxed[]        = _("Makkelik");
const u8 gText_Stats_CatchRate_Easy[]           = _("Vre makkelik");
const u8 gText_Stats_ExpYield[]      = _("Exp. Winst: ");
const u8 gText_Stats_EggCycles[]     = _("Uitbroeden stappen:");
...
const u8 gText_Stats_Growthrate[]    = _("Groei: ");
const u8 gText_Stats_Friendship[]    = _("Vriendskap:");
...
const u8 gText_Dex_SEEN[]   = _("Hezien");
const u8 gText_Dex_OWN[]    = _("Eigenoare");
